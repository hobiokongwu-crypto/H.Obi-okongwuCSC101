fn main() {
    ...
    //This means the slice starts from index 0 and goes up to ndex 3 (exclusive)
    ...
    let slice4 = &numbers[..];
    //This means the slice starts from idex 0 and goes up to index 5 (exclusive)
    println!("index 0 to indexw 5 sliced = {:?}", slice4);
}